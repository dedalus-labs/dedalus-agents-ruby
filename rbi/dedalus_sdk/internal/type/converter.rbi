  ...
  module Internal
    module Type
      ...
      module Converter
        ...
        Input =
          T.type_alias do
            T.any(DedalusSDK::Internal::Type::Converter, T::Class[T.anything])
          end
        ...
        class << self
          ...
          sig do
            params(translate_names: T::Boolean).returns(
              DedalusSDK::Internal::Type::Converter::CoerceState
            )
          end
          ...
          sig do
            params(
              target: DedalusSDK::Internal::Type::Converter::Input,
              value: T.anything,
              state: DedalusSDK::Internal::Type::Converter::CoerceState
            ).returns(T.anything)
          end
