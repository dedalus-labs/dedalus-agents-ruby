...
class DedalusSDK::Test::PrimitiveModelTest < Minitest::Test
  A = DedalusSDK::Internal::Type::ArrayOf[-> { Integer }]
  H = DedalusSDK::Internal::Type::HashOf[-> { Integer }, nil?: true]
  ...
  class B < DedalusSDK::Internal::Type::BaseModel
    optional :a, Integer
    optional :b, B
  end
  ...
  def test_typing
    converters = [
      ...
      DedalusSDK::Internal::Type::Boolean,
      A,
      H,
      E,
      U,
    ...
    converters.each do |conv|
      assert_pattern do
        conv => DedalusSDK::Internal::Type::Converter
      end
    end
  end
  ...
  def test_coerce
    cases = {
      [DedalusSDK::Internal::Type::Unknown, :a] => [{yes: 1}, :a],
      [NilClass, :a] => [{maybe: 1}, nil],
      [NilClass, nil] => [{yes: 1}, nil],
      [DedalusSDK::Internal::Type::Boolean, true] => [{yes: 1}, true],
      [DedalusSDK::Internal::Type::Boolean, "true"] => [{no: 1}, "true"],
      [Integer, 1] => [{yes: 1}, 1],
    ...
    cases.each do |lhs, rhs|
      ...
      state = DedalusSDK::Internal::Type::Converter.new_coerce_state
      assert_pattern do
        DedalusSDK::Internal::Type::Converter.coerce(target, input, state: state) => ^expect
  ...
  def test_dump
    cases = {
      [DedalusSDK::Internal::Type::Unknown, B.new(a: "one", b: B.new(a: 1.0))] => {a: "one", b: {a: 1}},
      ...
      [DedalusSDK::Internal::Type::Boolean, true] => true,
      [DedalusSDK::Internal::Type::Boolean, "true"] => "true",
      [Integer, "1"] => "1",
      [Float, 1] => 1,
      [String, "one"] => "one",
      ...
      [String, Pathname(__FILE__)] => DedalusSDK::FilePart
    }
    ...
    cases.each do
      ...
      expect = _2
      assert_pattern do
        DedalusSDK::Internal::Type::Converter.dump(target, input) => ^expect
      end
    end
  end
  ...
  def test_coerce_errors
    ...
    cases.each do |testcase, expect|
      ...
      state = DedalusSDK::Internal::Type::Converter.new_coerce_state
      DedalusSDK::Internal::Type::Converter.coerce(target, input, state: state)
      assert_pattern do
        state => {error: ^expect}
      end
    end
  ...
  def test_dump_retry
    ...
    Pathname(__FILE__).open do |fd|
      ...
      types.product(cases).each do |target, input|
        ...
        DedalusSDK::Internal::Type::Converter.dump(target, input, state: state)
...
class DedalusSDK::Test::EnumModelTest < Minitest::Test
  class E0
    include DedalusSDK::Internal::Type::Enum
...
class DedalusSDK::Test::CollectionModelTest < Minitest::Test
  A1 = DedalusSDK::Internal::Type::ArrayOf[-> { Integer }]
  H1 = DedalusSDK::Internal::Type::HashOf[Integer]

  A2 = DedalusSDK::Internal::Type::ArrayOf[H1]
  H2 = DedalusSDK::Internal::Type::HashOf[-> { A1 }]

  A3 = DedalusSDK::Internal::Type::ArrayOf[Integer, nil?: true]
  H3 = DedalusSDK::Internal::Type::HashOf[Integer, nil?: true]
...
class DedalusSDK::Test::BaseModelTest < Minitest::Test
  class M1 < DedalusSDK::Internal::Type::BaseModel
    required :a, Integer
  end
  ...
  class M3 < DedalusSDK::Internal::Type::BaseModel
    optional :c, const: :c
    required :d, const: :d
  end
  ...
  class M5 < DedalusSDK::Internal::Type::BaseModel
    request_only do
      required :c, const: :c
    end
  ...
  class M6 < M1
    required :a, DedalusSDK::Internal::Type::ArrayOf[M6]
    optional :b, M6
  end
  ...
  def test_coerce
    ...
    cases.each do |lhs, rhs|
      ...
      state = DedalusSDK::Internal::Type::Converter.new_coerce_state
      assert_pattern do
        coerced = DedalusSDK::Internal::Type::Converter.coerce(target, input, state: state)
        assert_equal(coerced, coerced)
        if coerced.is_a?(DedalusSDK::Internal::Type::BaseModel)
          coerced.to_h => ^expect
        else
          coerced => ^expect
        end
      ...
      attributes.each do |accessor, expect|
        ...
        in Class if expect <= StandardError
          tap do
            ...
            flunk
          rescue DedalusSDK::Errors::ConversionError => e
...
class DedalusSDK::Test::UnionTest < Minitest::Test
  class U0
    include DedalusSDK::Internal::Type::Union
  ...
  class M2 < DedalusSDK::Internal::Type::BaseModel
  ...
  class M4 < DedalusSDK::Internal::Type::BaseModel
    optional :recur, -> { U5 }
    required :a, DedalusSDK::Internal::Type::ArrayOf[-> { U5 }]
  end

  class M5 < DedalusSDK::Internal::Type::BaseModel
    optional :recur, -> { U5 }
    required :b, DedalusSDK::Internal::Type::ArrayOf[-> { U5 }]
  end
...
class DedalusSDK::Test::BaseModelQoLTest < Minitest::Test
  class E0
    include DedalusSDK::Internal::Type::Enum
  ...
  def test_equality
    cases = {
      [DedalusSDK::Internal::Type::Unknown, DedalusSDK::Internal::Type::Unknown] => true,
      [DedalusSDK::Internal::Type::Boolean, DedalusSDK::Internal::Type::Boolean] => true,
      [DedalusSDK::Internal::Type::Unknown, DedalusSDK::Internal::Type::Boolean] => false,
...
class DedalusSDK::Test::MetaInfoTest < Minitest::Test
  A1 = DedalusSDK::Internal::Type::ArrayOf[Integer, nil?: true, doc: "dog"]
  H1 = DedalusSDK::Internal::Type::HashOf[-> { String }, nil?: true, doc: "dawg"]
