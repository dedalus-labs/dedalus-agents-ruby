...
class DedalusSDK::Test::SingletonClient < DedalusSDK::Client
  include Singleton

  TEST_API_BASE_URL = ENV.fetch("TEST_API_BASE_URL", "http://localhost:4010")

  def initialize
    super(base_url: DedalusSDK::Test::SingletonClient::TEST_API_BASE_URL, api_key: "My API Key")
  end
end
...
class DedalusSDK::Test::ResourceTest < Minitest::Test
  def async?
  ...
  def before_all
    super
    @dedalus = DedalusSDK::Test::SingletonClient.instance
  end
