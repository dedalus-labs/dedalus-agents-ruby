...
Most of the SDK is generated code. Modifications to code will be persisted between generations, but may result in merge conflicts between manual patches and changes from the generator. The generator will never modify the contents of `lib/dedalus_sdk/helpers/` and `examples/` directory.
...
require_relative "../lib/dedalus_sdk"
...
```ruby
gem "dedalus-sdk", git: "https://github.com/stainless-sdks/dedalus-sdk-ruby"
```

Alternatively, reference local copy of the repo:

```bash
$ git clone -- 'https://github.com/stainless-sdks/dedalus-sdk-ruby' '<path-to-repo>'
```

```ruby
gem "dedalus-sdk", path: "<path-to-repo>"
```
