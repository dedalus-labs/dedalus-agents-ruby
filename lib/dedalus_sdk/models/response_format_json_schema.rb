...
module DedalusSDK
  module Models
    class ResponseFormatJSONSchema < DedalusSDK::Internal::Type::BaseModel
      ...
      #
      #   @return [DedalusSDK::Models::ResponseFormatJSONSchema::JSONSchema]
      required :json_schema, -> { DedalusSDK::ResponseFormatJSONSchema::JSONSchema }
      ...
      #
      #   @param json_schema [DedalusSDK::Models::ResponseFormatJSONSchema::JSONSchema] Structured Outputs configuration options, including a JSON Schema.
      #
      #   @param type [Symbol, :json_schema] The type of response format being defined. Always `json_schema`.

      # @see DedalusSDK::Models::ResponseFormatJSONSchema#json_schema
      class JSONSchema < DedalusSDK::Internal::Type::BaseModel
        ...
        optional :schema, DedalusSDK::Internal::Type::HashOf[DedalusSDK::Internal::Type::Unknown]
        ...
        #
        #   @return [Boolean, nil]
        optional :strict, DedalusSDK::Internal::Type::Boolean, nil?: true

        # @!method initialize(name:, description: nil, schema: nil, strict: nil)
        #   Some parameter documentations has been truncated, see
        #   {DedalusSDK::Models::ResponseFormatJSONSchema::JSONSchema} for more details.
        #
        #   Structured Outputs configuration options, including a JSON Schema.
        #
