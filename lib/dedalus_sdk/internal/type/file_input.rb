...
module DedalusSDK
  module Internal
    module Type
      ...
      # `DedalusSDK::Internal::Type::FileInput`.
      #
      ...
      class FileInput
        ...
        def self.===(other)
          case other
          in Pathname | StringIO | IO | String | DedalusSDK::FilePart
            true
          else
            false
          end
        ...
        #
        # @return [Boolean]
        def self.==(other) = other.is_a?(Class) && other <= DedalusSDK::Internal::Type::FileInput
        ...
        class << self
          ...
          def dump(value, state:)
            ...
            in StringIO | String
              ...
              DedalusSDK::FilePart.new(value, filename: "upload")
            in IO
              state[:can_retry] = false
              value.to_path.nil? ? DedalusSDK::FilePart.new(value, filename: "upload") : value
            in DedalusSDK::FilePart if value.content.is_a?(IO)
              state[:can_retry] = false
              value
            else
              value
