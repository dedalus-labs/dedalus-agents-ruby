  ...
  module Internal
    module Type
      ...
      module BaseStream
        ...
        #
        # @return [void]
        def close = DedalusSDK::Internal::Util.close_fused!(@iterator)
        ...
        # @api private
        #
        # @param model [Class, DedalusSDK::Internal::Type::Converter]
        ...
        # @return [String]
        def inspect
          model = DedalusSDK::Internal::Type::Converter.inspect(@model, depth: 1)
